...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  # using a specific IP.
  config.vm.network "private_network", ip: "__IPV4ADDRESS__"
  ...
  config.vm.provision :shell, :path => "./script/11-selinux-off.sh",:privileged   => true
